...
export const INITIAL_REPORTS_DATA: WorkReport[] = [
  {
    ...
    visitorName: '강인호',
    confirmerName: '권순형',
    confirmerSignature: '/assets/img/sample_signature.svg',
    photoDoor: '',
    photoBefore1: '',
    photoAfter1: '',
    photoBefore2: '',
