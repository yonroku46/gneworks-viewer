...
export const upsertReport = (report: Partial<WorkReport> & { siteName: string; dong: string; ho: string }): WorkReport => {
  ...
  if (existingIdx >= 0) {
    ...
    updatedReport = {
      ...
      photoDoor: report.photoDoor || '',
      photoBefore1: report.photoBefore1 || '',
      photoAfter1: report.photoAfter1 || '',
      photoBefore2: report.photoBefore2 || '',
      photoAfter2: report.photoAfter2 || '',
      submittedAt: timeStr,
